...
\begin{itemize}
		\resitem{Python, Rust, C/C++, bash/shell, SQL, MongoDB, C\#, Java, code debugging, fast-learner, detail-oriented, GNU/Linux, Windows, system/network administration, Git, PyTorch, Computer Vision, Scikit-learn, LaTeX, technical writing, technical support}
	\end{itemize}
