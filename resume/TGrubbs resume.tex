...
\begin{itemize}
		\resitem{Python, C/C++, bash/shell, SQL, C\#, Java, code debugging, fast-learner, detail-oriented, GNU/Linux, Windows, system/network administration, Git, PyTorch, Computer Vision, Scikit-learn, LaTeX, technical writing, technical support}
	\end{itemize}
...
\item
	...
	\begin{itemize}
      \resitem{Simulated the travel of ultracold neutrons through potential experimental setups in C++.}
