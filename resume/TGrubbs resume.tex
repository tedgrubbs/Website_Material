...
\href{https://www.linkedin.com/in/taylor-grubbs/}{Linkedin: www.linkedin.com/in/taylor-grubbs/}
...
\resheading{Core Skills}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{itemize}
		\resitem{Python, Rust, C/C++, bash/shell, SQL, MongoDB, C\#, Java, code debugging, fast-learner, detail-oriented, GNU/Linux, Windows, system/network administration, Git, PyTorch, Deep Learning, Computer Vision, Scikit-learn, LaTeX, technical writing, technical support}
	\end{itemize}
